...
function showJoke() {
  ...
  const jokePargElm = document.createElement("p");
  jokePargElm.textContent = randomJokeText;

  clearAll();

  jokeContainer.appendChild(jokePargElm);
}
...
function showQuote() {
  ...
  const quoteParElem = document.createElement("p");
  const authorElem = document.createElement("p");

  quoteParElem.textContent = randomQuote.quote;
  authorElem.textContent = "- " + randomQuote.author;

  clearAll();

  quoteContainer.appendChild(quoteParElem);
...
function showRiddle() {
  ...
  // unpacking the randomRiddle object
...
function revealAnswers() {
  const riddleQuestionElm = document.querySelector(".riddle-content");
  const riddle = riddleQuestionElm.querySelector("p");
  ...
  if (riddle && riddleAnswer.hidden) {
    ...
    alert("There is no riddle to show the answer to!");
  }
}
